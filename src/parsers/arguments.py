...
def parse_args():
    ...
    parser.add_argument("--tts_service", choices=["elevenlabs", "openai", "edge_tts"], default="elevenlabs",
                        help="Choose which TTS service to use ('elevenlabs', 'openai', or the free 'edge_tts').")
    ...
    parser.add_argument("--edge_tts_voice", default="en-US-ChristopherNeural",
                        help="Edge TTS voice name, used when --tts_service is 'edge_tts' (default: en-US-ChristopherNeural).")
    parser.add_argument("--image_service", choices=["replicate", "pollinations"], default="replicate",
                        help="Choose which image generation service to use ('replicate' or the free 'pollinations').")
